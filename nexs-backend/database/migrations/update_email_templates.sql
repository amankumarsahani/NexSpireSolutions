-- UPDATE queries for default email templates
-- Run these to update existing templates with professional SVG icons and proper domain
...
<body>
    ...
    variables = '["contact_name", "email", "company_name"]',
    updated_at = NOW()
WHERE name = 'welcome-email';

-- 2. Update Project Proposal Template
UPDATE email_templates SET 
    type = 'email',
...
<body>
    ...
    variables = '["contact_name", "company_name", "project_description"]',
    updated_at = NOW()
WHERE name = 'project-proposal';

-- 3. Update Follow-up Email Template
UPDATE email_templates SET 
    type = 'email',
...
-- 4. Update Project Update Template
UPDATE email_templates SET 
    type = 'email',
...
<body>
    ...
    variables = '["contact_name", "project_name", "progress_percentage", "milestone_title", "milestone_description", "next_steps"]',
    updated_at = NOW()
WHERE name = 'project-update';

-- 5. Update Thank You Email Template (with professional SVG icon instead of emoji)
UPDATE email_templates SET 
    type = 'email',
...
-- 6. Update Meeting Confirmation Template (with professional SVG icons instead of emojis)
UPDATE email_templates SET 
    type = 'email',
...
<body>
    ...
    variables = '["contact_name", "meeting_date", "meeting_time", "meeting_location", "meeting_agenda"]',
    updated_at = NOW()
WHERE name = 'meeting-confirmation';

-- Show updated templates
SELECT id, name, category, is_active, updated_at FROM email_templates;
