...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Welcome to <strong>{{brand_name}}</strong>! We are thrilled to have you on board.</p>
            <p>At {{brand_name}}, we are committed to delivering exceptional digital solutions that help businesses thrive in the modern landscape.</p>
            ...
            <a href="{{brand_website}}" class="btn">Visit Our Website</a>
        </div>
        <div class="footer">
    ...
    },
    {
        ...
        type: 'email',
        subject: 'Project Proposal from {{brand_name}}',
        html_content: `<!DOCTYPE html>
<html>
<head>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear {{contact_name}},</p>
            <p>Thank you for considering <strong>{{brand_name}}</strong> for your project. We are excited about the opportunity to work with {{company_name}}.</p>
            <div class="highlight">
    ...
    },
    {
        name: 'follow-up',
        type: 'email',
        subject: 'Following Up - {{brand_name}}',
        html_content: `<!DOCTYPE html>
<html>
<head>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>I understand you might be busy, but I wanted to ensure you have all the information you need to make a decision. Our team at {{brand_name}} is ready to help bring your vision to life.</p>
            <p>Would you have time for a quick call this week to discuss the next steps?</p>
            <p>Looking forward to hearing from you!</p>
            <a href="mailto:{{brand_support_email}}" class="btn">Reply to This Email</a>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} {{brand_name}}. All rights reserved.</p>
        </div>
...
<body>
    ...
    },
    {
        name: 'thank-you',
        type: 'email',
        subject: 'Thank You for Choosing {{brand_name}}!',
        html_content: `<!DOCTYPE html>
<html>
<head>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear {{contact_name}},</p>
            <p>We just wanted to take a moment to say <strong>THANK YOU</strong> for choosing {{brand_name}}.</p>
            ...
            <a href="{{brand_website}}" class="btn">Stay Connected</a>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} {{brand_name}}. All rights reserved.</p>
        </div>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi {{contact_name}},</p>
            <p>Your meeting with {{brand_name}} has been confirmed!</p>
            ...
            <a href="mailto:{{brand_support_email}}" class="btn-outline">Reschedule</a>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} {{brand_name}}. All rights reserved.</p>
        </div>
    ...
    },
    {
        ...
        type: 'email',
        subject: 'Service Agreement - {{brand_name}} | {{plan_name}} Plan',
        html_content: `<!DOCTYPE html>
<html>
<head>
    <style>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="steps">
                ...
                <div class="step"><div class="step-num">2</div><div class="step-text">Your {{brand_crm_product}} dashboard is being set up at <strong>{{tenant_slug}}.{{brand_base_domain}}</strong></div></div>
