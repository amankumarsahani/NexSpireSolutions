export default function AuthorBio({
    ...
    return (
        <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-2xl p-8 border border-slate-200">
            <div className="flex flex-col sm:flex-row gap-6 items-start">
                ...
                <div className="flex-shrink-0">
                    {avatar ? (
                        ...
                        <div className="w-20 h-20 rounded-2xl bg-[#0F766E] flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                            {initials}
                        </div>
                    )}
                </div>
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-medium text-[#0F766E] uppercase tracking-wider">Written by</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a
                            ...
                            className="w-9 h-9 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#0F766E] hover:border-blue-600 transition-all"
                        >
