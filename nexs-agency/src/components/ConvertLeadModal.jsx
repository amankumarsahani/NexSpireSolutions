            ...
            >
                ...
                <div className="p-6">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                        <p className="text-sm text-blue-800 flex items-start gap-2">
                            ...
                            <span>
                                This will create a new client record using the lead's information and mark the lead as "Converted".
                            </span>
                        </p>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700">{lead.contact_name}</span>
                            </div>
                            <div className="flex items-center gap-2">
                ...
                <div className="bg-gray-50 px-6 py-4 flex gap-3 justify-end rounded-b-xl">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        disabled={loading}
                    >
                        {loading ? (
                            <>
