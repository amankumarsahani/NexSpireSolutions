    ...
    <section id="partners" className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-left mb-16 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <span className="text-sm font-semibold text-[#0F766E] uppercase tracking-wider">Trusted Partnerships</span>
        ...
        <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          {[
            { icon: "ri-team-line", number: "50+", label: "Technology Partners", bgColor: "bg-[#0F766E]/10", textColor: "text-[#0F766E]" },
            ...
            <div className="relative">
              ...
              <div className="flex animate-slide-left space-x-6 w-max">
                {[
                  ...
                  { logo: "Azure", name: "Microsoft Azure", type: "Cloud Partner", desc: "Azure certified professional delivering enterprise cloud transformation", bgColor: "bg-[#FAF9F6]", iconColor: "text-[#0F766E]", borderColor: "border-slate-200" },
            ...
            <div className="relative">
              ...
              <div className="flex animate-slide-left space-x-6 w-max">
                {[
                  ...
                  { icon: "ri-medal-line", title: "Azure Developer Associate", provider: "Microsoft", year: "2024", bgColor: "bg-[#FAF9F6]", iconColor: "text-[#0F766E]" },
                  ...
                  { icon: "ri-shield-star-line", title: "Kubernetes Administrator", provider: "CNCF", year: "2024", bgColor: "bg-[#0F766E]/10", iconColor: "text-[#0F766E]" },
        ...
        <div className={`transition-all duration-1000 delay-900 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <div className="bg-[#0F766E] rounded-2xl p-8 md:p-12 text-center text-white shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <a
                className="bg-white text-[#0F766E] px-8 py-4 rounded-xl font-semibold hover:bg-[#FAF9F6] transition-all duration-300 cursor-pointer"
                href="#contact"
              >
