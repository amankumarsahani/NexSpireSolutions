    ...
    <section id="contact" className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-left mb-16">
          <span className="text-sm font-semibold text-[#0F766E] uppercase tracking-wider">Let's Connect</span>
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 h-full flex flex-col">
              <div className="flex items-center mb-6">
                <div className="w-10 h-10 bg-[#0F766E] rounded-lg flex items-center justify-center mr-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 h-full flex flex-col">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          minLength={2}
                          maxLength={100}
                          className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-[#0F766E] focus:border-[#0F766E] transition-all bg-white text-sm"
                          placeholder="Name"
                        />
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative h-full">
                      <textarea
                        ...
                        minLength={10}
                        maxLength={2000}
                        className="w-full h-32 px-4 py-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-[#0F766E] focus:border-[#0F766E] transition-all resize-none bg-white text-sm"
                  ...
                  <div className="mt-auto space-y-4">
                    ...
                    <button
                      ...
                      className="w-full bg-[#0F766E] hover:bg-[#0D6B63] text-white py-3 rounded-lg font-semibold transition-all duration-300 text-sm disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 pt-3 border-t border-slate-200">
                      ...
                      <div className="flex items-center">
                        <i className="ri-time-line mr-2 text-[#0F766E]"></i>
                  ...
                  <div key={index} className="group">
                    <div className="bg-white rounded-lg p-4 shadow-sm border border-slate-200 hover:shadow-lg transition-all duration-300">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-[#0F766E] rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-[#0F766E] font-medium mb-1 text-xs">
                            {info.details}
                          </p>
                  ...
                  <div className="flex space-x-2 pl-13">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className="w-8 h-8 bg-[#FAF9F6] rounded-lg flex items-center justify-center border border-slate-200 hover:border-[#0F766E]/30 hover:bg-[#0F766E]/5 transition-all duration-300 group"
                      >
                        <i className={`${social.icon} text-xs text-slate-600 group-hover:text-[#0F766E]`}></i>
                      </a>
                    ))}
                  </div>
                </div>
