                ...
                <div className="relative bg-white rounded-2xl border border-slate-200 hover:border-slate-300 transition-all duration-300 overflow-hidden">
                  ...
                  >
                    <div className="flex items-center space-x-4 flex-1">
                      <div className="w-8 h-8 bg-[#2563EB] rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-sm">
                        {String(index + 1).padStart(2, '0')}
                      </div>
                      
                      <h3 className="font-semibold text-slate-800 text-lg group-hover:text-[#2563EB] transition-colors duration-300">
                        {faq.question}
                      </h3>
                    </div>
                    ...
                    <div className="px-6 pb-6 animate-fadeIn">
                      <div className="pl-12 pr-16">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <a 
                            href="#contact"
                            className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300"
                          >
                            Need More Help?
                          </a>
                        </div>
