                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-500 border border-slate-200 text-center h-full">
                                    {/* Step Number Badge */}
                                    <div className={`w-16 h-16 rounded-2xl bg-[#0F766E] flex items-center justify-center mx-auto mb-6 text-white text-2xl shadow-lg group- transition-transform duration-500`}>
