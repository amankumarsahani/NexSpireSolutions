    ...
    <section id="technologies" className="relative py-12 sm:py-16 lg:py-20 bg-[#F0FFF4] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <div className="inline-flex items-center bg-[#059669]/10 border border-slate-200 text-slate-800 text-sm font-bold px-8 py-4 rounded-full mb-8">
            <div className="w-3 h-3 bg-[#059669] rounded-full mr-3"></div>
            Our Tech Stack
          </div>
          ...
          {Object.keys(techStacks).map((tab) => (
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-3 rounded-2xl text-sm sm:text-base font-semibold transition-all duration-300 whitespace-nowrap border ${activeTab === tab
                ? 'bg-[#059669] text-white shadow-lg border-[#059669]'
                : 'bg-white text-slate-600 hover:bg-[#FAF9F6] border-slate-200 hover:shadow-lg'
                }`}
            >
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full transition-all duration-300 ${activeTab === tab ? 'bg-white' : 'bg-[#059669]'
                  }`}></div>
                <span>{tab}</span>
              </div>
            </button>
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-2xl border border-slate-200 shadow-lg">
                <div className="w-12 h-12 bg-[#059669] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
