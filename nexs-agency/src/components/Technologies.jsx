        ...
        <div className={`flex flex-wrap justify-center gap-2 sm:gap-3 mb-8 sm:mb-12 lg:mb-16 transition-all duration-1000 delay-300 transform ${
          ...
          {Object.keys(techStacks).map((tab) => (
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-3 rounded-2xl text-sm sm:text-base font-semibold transition-all duration-500 whitespace-nowrap backdrop-blur-sm border ${
                activeTab === tab
            ...
            >
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  activeTab === tab ? 'bg-white' : 'bg-cyan-500'
                }`}></div>
                <span>{tab}</span>
              </div>
            </button>
