      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`transition-all duration-1000 delay-900 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">
              <span className="block text-gray-800 font-bold">Brilliant Minds</span>
              <span className="block bg-gradient-to-r from-rose-600 via-pink-600 to-fuchsia-600 bg-clip-text text-transparent mt-2 font-bold">
                Behind Innovation
              </span>
            </h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover the passionate professionals who transform ideas into digital masterpieces
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 justify-items-center max-w-5xl mx-auto">
            {teamMembers.map((member, index) => {
              const memberColors = [
                ...
                { primary: '#ec4899', secondary: '#f97316', bg: 'from-pink-500/15 to-orange-500/15' },
                    ...
                    <div className="text-center mb-6">
                      ...
                      <div className="flex flex-wrap justify-center gap-2">
                        {member.skills.slice(0, 2).map((skill, skillIndex) => (
                          <span
                            key={skillIndex}
                            className="px-3 py-1.5 bg-white/20 backdrop-blur-sm border border-white/40 text-gray-700 rounded-2xl text-xs font-semibold transition-all duration-300"
                          >
                            {skill}
                          </span>
                        ))}
