...
export default function EditProjectModal({ isOpen, onClose, onSave, project, clients }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-labelledby="modal-title-editproject">
            <div
            ...
            >
                ...
                <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
                    <h3 id="modal-title-editproject" className="text-xl font-bold text-gray-900 flex items-center gap-2">
