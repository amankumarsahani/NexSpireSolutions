      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            >
              <div className="relative">
                <div className="w-9 h-9 bg-[#0F766E] rounded-xl flex items-center justify-center shadow-lg transition-all duration-300">
                        ...
                        <div className="flex flex-col gap-1">
                          {item.children.map((child) => (
                            <Link
                              ...
                              onFocus={() => setIsServicesOpen(true)}
                              onBlur={() => { setTimeout(() => setIsServicesOpen(false), 150); }}
                              className="px-4 py-3 text-sm font-medium text-slate-700 hover:bg-[#FAF9F6] hover:text-[#0F766E] rounded-xl transition-colors text-left flex items-center justify-between group/item"
                            >
                              {child.label}
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/contact"
              className="group bg-[#0F766E] hover:bg-[#0D6B63] text-white px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 shadow-lg"
            >
            ...
            <nav className="py-4">
                    ...
                    {item.children ? (
                      <button
                        ...
                        className={`relative z-10 w-full text-left px-4 py-2 text-base font-semibold rounded-xl transition-all duration-300 cursor-pointer ${isActive(item.path)
                          ? 'text-white bg-[#0F766E] shadow-lg'
                          : 'text-slate-700 hover:text-[#0F766E] hover:bg-[#FAF9F6]'
                          }`}
                      >
                        ...
                        <div className="pl-6 pr-2 space-y-1 border-l-2 border-slate-200 ml-4 pb-2">
                          {item.children.map(child => (
                            <Link
                              ...
                              className="block px-4 py-2 text-sm font-medium text-slate-600 hover:text-[#0F766E]"
                            >
                              {child.label}
                            </Link>
                          ))}
              ...
              <div className="relative px-4 pt-4 mt-4">
                ...
                <Link
                  to="/contact"
                  onClick={() => setIsMenuOpen(false)}
                  className="relative block w-full px-4 py-3 bg-[#0F766E] hover:bg-[#0D6B63] text-white text-center text-base font-bold rounded-xl transition-all duration-300 shadow-lg"
                >
                  Get Started
                </Link>
              </div>
