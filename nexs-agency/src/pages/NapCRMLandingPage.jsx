...
export default function NapCRMLandingPage() {
    const {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden selection:bg-[#2563EB]/10">
            <Helmet>
                ...
                <meta property="og:title" content="NapCRM - All-in-One CRM for Agencies &amp; Businesses" />
                <meta property="og:description" content="NapCRM is the complete operating system for modern agencies. Integrated lead management, e-commerce, invoicing, team chat, and client portals." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={`${SITE_URL}/napcrm`} />
                ...
                <meta name="twitter:title" content="NapCRM - All-in-One CRM for Agencies &amp; Businesses" />
            ...
            <section className="py-12 border-b border-slate-100 bg-slate-50/50 overflow-hidden">
                <div className="flex gap-12 animate-scroll w-max hover:pause-scroll">
                    {[...industries, ...industries, ...industries].map((ind, i) => (
                        <Link key={`${ind.name}-${i}`} to={`/napcrm/industries/${ind.slug}`} className="flex items-center gap-3 opacity-60 hover:opacity-100 transition-opacity">
