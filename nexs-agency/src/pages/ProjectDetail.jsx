        ...
        <div className="min-h-screen bg-white font-sans text-slate-800 selection:bg-blue-600 selection:text-white">
            ...
            <section className="py-12">
                <div className="container-custom">
                    <span className="inline-block px-4 py-2 bg-[#0F766E]/10 text-[#0F766E] rounded-full text-sm font-bold mb-6">
                        {project.category}
                    </span>
                    ...
                    <div className="grid lg:grid-cols-3 gap-16">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 text-lg leading-relaxed">{project.solution}</p>
                            </div>
                            ...
                            <div className="bg-[#FAF9F6] p-8 rounded-2xl border border-slate-200">
                                ...
                                <p className="font-bold text-[#0F766E]">- {project.testimonial.author}</p>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.technologies.map(tech => (
                                        <span key={tech} className="px-4 py-2 bg-gray-100 text-slate-600 rounded-lg text-sm font-bold">
                                            {tech}
                                        </span>
                                    ))}
                                </div>
            ...
            <section className="py-24 bg-blue-600 text-white text-center">
                <div className="container-custom">
                    ...
                    <Link
                        to="/contact"
                        className="inline-block px-10 py-4 bg-white text-[#0F766E] rounded-full font-bold text-lg hover:shadow-xl transition-all "
                    >
